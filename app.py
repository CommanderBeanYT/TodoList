...
urlarc = "https://szxaarjqdvgbsmmmernl.supabase.co/rest/v1/Archived_Tasks"
headers = {
...
def archive():
    if not offline:
        archivedTasks = get_archive()
        print(archivedTasks)
        return render_template("archive.html", list=archivedTasks)
    else:
        return render_template("archive.html", list=defaultList)
